	...
	<div style = "margin-left:0;" class = "container">
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<br />
				<strong><h4 style = "color:#ff0000;">1. Tripify</h4></strong>
				<p>Welcome to the Sri Lankan Hotel Reservation Application, your one-stop solution for convenient and hassle-free hotel bookings across beautiful Sri Lanka. Our application aims to provide a seamless experience for travelers seeking accommodation in this enchanting island nation. Whether you're planning a family vacation, a romantic getaway, or a business trip, we have you covered. </p>
				<br />
